    ...
    <div class="container">
        <div id="pf-hd">
            ...
            <div class="pf-user">
                ...
                <!--用户名-->
                <h4 class="pf-user-name ellipsis">zhangsan</h4>
        ...
        <div id="pf-bd">
            <div id="pf-sider">
                ...
                <ul class="sider-nav">
                     <!--<li class="current">-->
                    <li>
                        <a href="javascript:addTab('纳税人管理','manage/jsp/listTaxPayer2.jsp');">
                     ...
                     <li>
                        ...
                        <ul class="sider-nav-s">
                            <li class="active"><a href="javascript:addTab('任务查询','manage/jsp/searchTask.jsp')">调查任务查询</a></li>
                            <li><a href="javascript:addTab('调查任务录入','manage/jsp/addTask.jsp')">调查任务录入</a></li>
